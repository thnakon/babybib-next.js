          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
            <FieldGroup>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button variant="outline" type="button" className="w-full bg-transparent border-input hover:bg-muted/50 transition-colors">
              ...
              <FieldDescription className="text-center">
                ...
                <Link href="/signup" className="text-[#407bc4] hover:underline underline-offset-4 pointer-events-auto font-medium">
                  Sign up
                </Link>
              </FieldDescription>
            </FieldGroup>
